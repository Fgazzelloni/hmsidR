...
![SIR Model with Python](images/appendixC_pysir.png)

The code for this example is adapted from: [
Modeling Infectious Diseases in Humans and Animals
Matt J. Keeling & Pejman Rohani](https://homepages.warwick.ac.uk/~masfz/ModelingInfectiousDiseases/Chapter2/Program_2.1/index.html).
