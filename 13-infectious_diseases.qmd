...
![Who adapts to whom? - (AI generated
image)](images/13_adaptation.png){#fig-adapt_virus
fig-align="center" width="437"
fig-alt="Who adapts to whom? - (AI generated image)"}
...
4.  **Transmission Rate**: The transmission rate often depends on how a
    ...
    are also influenced by human behaviors, such as hygiene practices
...
Furthermore, the use machine learning models used to predict the
