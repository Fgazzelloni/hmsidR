...
Download and install R and RStudio Desktop: <https://posit.co/download/rstudio-desktop/>

## How to setup this project with quarto

[**Quarto**](https://quarto.org/) is the new version of [**Rmarkdown**](https://rmarkdown.rstudio.com/), it can be used for making notes, presentations, websites, books and more.

In this project the book has been made in quarto and version saved on github.

For more information about how to publish a quarto book have a look here: [Quarto publishing](https://quarto.org/docs/publishing/github-pages.html)
...
Build tab and ---\> More ---\> clean and install (this is not there anymore when you start with `devtools::create("yourpkg")`) to add the new data to NAMESPACE
