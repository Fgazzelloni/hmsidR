...
variables, where one variable (*the cause*) directly influences the other (*the effect*). For example, regular exercise
...
![Causal Inference
Flowchart. The flowchart outlines the steps involved in performing causal inference, from formulating a hypothesis to informing public health actions.](images/04_causal_inference_flowchart.png){#fig-causal_inference
