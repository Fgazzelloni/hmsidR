...
### Example 2: Ischemic Stroke Decision Tree

In this example we have a look at hoe to visualize the results of a
...
standardize the predictors, `step_YeoJohnson()` to transform the
...
`tidymodels` package and visualize the results with the `rpart.plot`
package.
