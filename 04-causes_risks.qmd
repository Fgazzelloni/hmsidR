...
::: solutionbox-body
-   Understand key causes and risk factors
-   Define the research question
-   Get introduced to causal inference concepts
:::
::::::
...
cardiovascular disease\index{Cardiovascular disease}, and cancer.
...
-   **Lifestyle choices**\index{Lifestyle}: Poor diet, physical inactivity, tobacco use,
...
-   **Infections**\index{Infections}: Many diseases, such as tuberculosis, HIV/AIDS, and
    malaria, are caused by infectious agents.
-   **Poverty**\index{Poverty}: People living in poverty are often more susceptible to
...
-   Population Attributable Fractions
    (PAFs)\index{Population Attributable Fractions (PAFs)}
...
(exposure) and lung cancer\index{Lung cancer} (outcome). We want to calculate the relative
...
-   The second formula, $RR=\frac{d_1/n_1}{d_0/n_0}$, considers both the
    **number of events** $(d1, d0)$ and **person-time at risk**\index{Person-time at risk}
    $(n1, n0)$ for each group. This formula takes into account the
    **incidence rate**\index{Incidence rate} in addition to **event proportions**\index{Event proportions}, providing a
    more specific understanding of the relative risk by incorporating
    information about the **duration of exposure**\index{Duration of exposure}.
...
This is an example of a **Network graph**\index{Network graph} representing the causal
...
an experiment, where there are **treatment**\index{Treatment} and **outcome**\index{Outcome} elements.
