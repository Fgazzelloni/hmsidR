...
Health metrics are key variables to understand more about the state of health of a population.

In this book we'll learn about how to calculate the metrics, and then consider their variation due to causes and risks. In particular, how the effect of the spread of some infectious disease can influence them and affect the overall state of health of a population.

It was in late

**numbers of years of life lost (YLLs)** and the **numbers of years lived with disabilities (YLDs)**, sum them up to eventually obtain the key metric of **disability adjusted life years (DALYs)** identifying the numbers of years of life lost due to death or a disability status.
